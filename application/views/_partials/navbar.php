...
<body>
	<div class="bg-black">
		<nav class="navbar items-center  flex mx-auto bg-black justify-around p-3">
			<h1 class="tracking-tighter dm-sans text-neutral-200 font-semibold text-2xl">Cham<span class="text-blue-600">Shop</span></h1>
			<ul class="flex items-center gap-8 archivo text-sm">
				...
				<a class="text-neutral-400 hover:text-neutral-100 transition-all duration-300" href="<?= site_url('movie') ?>">Shopping</a>
			...
			<div>
				<a class="text-sm text-neutral-200" href="<?= site_url('auth/login') ?>" style="margin-left:auto">
					<button class="px-5 py-2 bg-red-600 rounded-full">Login</button>
				</a>
			</div>
	</div>
	</nav>
