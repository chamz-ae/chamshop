...
<body class="bg-black">
    ...
    <div class="container mx-auto p-4">
        <div class="text-center mt-10">
            <h1 class="text-2xl text-neutral-200 font-bold dm-sans mb-4">Search</h1>
            <p class="mb-4 text-neutral-300 archivo">Write down the keywords of the Shoes you want to search</p>
        </div>
