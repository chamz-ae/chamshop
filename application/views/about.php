...
<body class="bg-black">
    ...
    <div class="container mx-auto py-16 px-4">
        ...
        <div>
            ...
            <p class="text-neutral-400 text-center max-w-3xl mx-auto mt-8 archivo leading-7">Welcome to E-commers Website acham, Sebuah website yang menjualan sepatu bisa sangat beragam dalam penampilan dan fungsionalitasnya. Di bagian atas halaman utama, mungkin akan ada banner besar yang menampilkan produk unggulan atau diskon terbaru untuk menarik perhatian pengunjung. Biasanya, desainnya bersih dan modern dengan palet warna yang menarik tetapi tidak terlalu mencolok, agar fokus utama tetap pada produk.</p>
            <p class="uppercase font-light text-center text-neutral-400 tracking-wider mt-20">Rise 24 juny 2024</p>
        </div>

        <!-- for About Content -->
        <div class="mt-20">
            <h1 class="text-4xl font-bold text-center text-neutral-200 dm-sans tracking-tight">What is Cham<span class="text-blue-500">Shop</span></h1>
            <ul class="flex items-start justify-center mt-8 gap-5">
                <p class="max-w-xl text-neutral-400 text-sm archivo leading-6">Cham<span class="text-blue-600">Shop</span> ChamShop is an e-commers website for selling shoes, We believe that every shoe must have its advantages and disadvantages. I have foreign products and local products.</p>
        ...
        <div class="flex items-center mt-16 justify-center gap-10">
            <img src="https://res.cloudinary.com/dhyufaqzh/image/upload/v1719209913/k7ods55zfzi1dn12kgiq.jpg" class="rounded-3xl" alt="" width="600px" height="500px">
            <div>
                <ul>
                    <h1 class="text-2xl font-semibold dm-sans text-neutral-200">Website Review</h1>
                    <p class="max-w-xl archivo text-sm text-neutral-400 mt-2 leading-7">We provide in-depth and objective Website reviews, exploring every aspect from the storyline, characters, cinematography, to the moral message conveyed.</p>
                </ul>
                <ul class="mt-5">
                    <h1 class="text-2xl font-semibold dm-sans text-neutral-200">Recommended Shoes</h1>
